...
from .views import CopyScriptView, UnassignSnoozedLeadsCronView, ReleaseLeadsAfter12hCronView, SyncEntitySchemasCronView
...
urlpatterns = [
    ...
    path('sync-entities/', SyncEntitySchemasCronView.as_view(), name='cron-sync-entities'),
] 
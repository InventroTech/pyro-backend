...
urlpatterns = [
    ...
    path("records/distinct-values/", RecordDistinctFieldValuesView.as_view(), name="record-distinct-values"),
    ...
    path("records/<int:pk>/history/", RecordHistoryView.as_view(), name="record-history"),

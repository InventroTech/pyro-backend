...
class GetNextLeadView(APIView):
    ...
    Delegates to get_next_lead_service for the full pipeline.
    """
    permission_classes = [IsTenantAuthenticated]
    ...
    def get(self, request):
        ...
        See get_next_lead_service for the full pipeline.
        """
        from .get_next_lead_service import get_next_lead
        return get_next_lead(request)

...
# Advisory lock key: legacy support_ticket.id has no DB sequence in some environments.
...
def _allocate_support_ticket_ids(count: int) -> List[int]:
    ...
    The table predates Django migrations and may lack a serial/identity on ``id``,
...
def _load_inserted_support_tickets(
    ...
    """
    Return support_ticket rows that were persisted by bulk_create.
